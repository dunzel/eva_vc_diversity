...
### Job name
#SBATCH --job-name=eva-vc__n-50__mu-16__a-0.5__dist-uniform2__d-2

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/wy360425/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-50__mu-16__a-0.5__dist-uniform2__d-2.out
...
python3 main.py --n 50 --delta 2 --mu 16 --distribution uniform2 --alpha 0.5
