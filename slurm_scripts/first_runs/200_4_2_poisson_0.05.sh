...
### Job name
#SBATCH --job-name=eva-vc__n-200__mu-2__a-0.05__dist-poisson__d-4

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/wy360425/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-200__mu-2__a-0.05__dist-poisson__d-4.out
...
python3 main.py --n 200 --delta 4 --mu 2 --distribution poisson --alpha 0.05
