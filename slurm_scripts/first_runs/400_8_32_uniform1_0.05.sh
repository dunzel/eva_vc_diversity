...
### Job name
#SBATCH --job-name=eva-vc__n-400__mu-32__a-0.05__dist-uniform1__d-8

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/wy360425/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-400__mu-32__a-0.05__dist-uniform1__d-8.out
...
python3 main.py --n 400 --delta 8 --mu 32 --distribution uniform1 --alpha 0.05
