...
### Job name
#SBATCH --job-name=eva-vc__n-100__mu-16__a-0.5__dist-uniform3__d-4

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/wy360425/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-100__mu-16__a-0.5__dist-uniform3__d-4.out
...
python3 main.py --n 100 --delta 4 --mu 16 --distribution uniform3 --alpha 0.5
