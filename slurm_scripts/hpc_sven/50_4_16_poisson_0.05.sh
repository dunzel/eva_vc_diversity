...
### Job name
#SBATCH --job-name=eva-vc__n-50__mu-16__a-0.05__dist-poisson__d-4

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/wy360425/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-50__mu-16__a-0.05__dist-poisson__d-4.out
...
python3 main.py --n 50 --delta 4 --mu 16 --distribution poisson --alpha 0.05
