...
### Job name
#SBATCH --job-name=eva-vc__n-50__mu-2__a-0.05__dist-poisson__d-2

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/wy360425/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-50__mu-2__a-0.05__dist-poisson__d-2.out
...
python3 main.py --n 50 --delta 2 --mu 2 --distribution poisson --alpha 0.05
