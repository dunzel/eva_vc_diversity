...
### Job name
#SBATCH --job-name=eva-vc__n-200__mu-32__a-0.05__dist-poisson__d-8

### declare the merged STDOUT/STDERR file
#SBATCH --output=/home/er636027/eva_vc_diversity/slurm_scripts/outputs/eva-vc__n-200__mu-32__a-0.05__dist-poisson__d-8.out
...
python3 main.py --n 200 --delta 8 --mu 32 --distribution poisson --alpha 0.05
